...
export async function createInverseProportionalFunctionTasks({
  ...
  const data: Prisma.TaskCreateInput[] = [
    // Oppgave 1 - https://www.matematika.no/omvendt-proporsjonale-funksjoner-2-spor-iv/
    {
      ...
      title: "Oppgave 1a",
      description:
        "En hytteeier må bære 200 terassebord fra parkeringsplassen til hytta. Skriv ned funksjonsuttrykket som viser hvor mange timer han bruker dersom han klarer math$x& planker/time. Svar på formen math$f(x)=...&",
      category: { connect: { id: "cleeckaww000108l4h4gjekif" } },
      points: 100,
      answer: "f(x)=\\frac{200}{x}",
    },
    {
      id: "cleecr4gm000108kx9d636p65",
      title: "Oppgave 1b",
      description:
        "En hytteeier må bære 200 terassebord fra parkeringsplassen til hytta. Lag en verditabell og tegn grafen. Du kan bruke x-verdier fra 1 til 100. Godkjenn svar hos lærer.",
      category: { connect: { id: "cleeckaww000108l4h4gjekif" } },
      points: 100,
      answer: "dreven-fugl",
