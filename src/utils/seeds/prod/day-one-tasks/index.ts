...
const providedTasks: Prisma.TaskCreateInput[] = [
  ...
  // 2.31
  {
    ...
    description:
      "Klassen din skal arrangere en trinfest. De leier lys- og musikkanlegg for 2000kr. Utgiftene skal fordeles likt på festdeltagerne. Hva er prisen per deltaker når det er 10 deltakere?",
    answer: "200kr",
    placeholder: "\\placeholder[blank1]{}kr",
    points: 50,
  ...
  },
  {
    ...
    description:
      "Klassen din skal arrangere en trinfest. De leier lys- og musikkanlegg for 2000kr. Utgiftene skal fordeles likt på festdeltagerne. Hva er prisen per deltaker når det er 20 deltakere?",
    answer: "100kr",
    placeholder: "\\placeholder[blank1]{}kr",
    points: 50,
    category: { connect: { id: "cler3o0ps000208kxhg7u2v0n" } },
  ...
  // 2.33
  {
    ...
    description:
      "Mona skal kjøre en strekning på 40 km. Grafen viser sammenhengen mellom farten og tiden hun bruker. Bruk grafen når du svarer på spørsmålene. Hva har farten vært hvis hun bruker 0.8 time på 40 km? I km/h, oppgi bare tallet.",
    answer: "50",
    points: 50,
    category: { connect: { id: "cler3o0ps000208kxhg7u2v0n" } },
  },
  {
    ...
    image:
      "https://tliacbojiuhirqtqavdn.supabase.co/storage/v1/object/public/task-images/day-one-tasks/task-2.33.png",
    description:
      "Mona skal kjøre en strekning på 40 km. Grafen viser sammenhengen mellom farten og tiden hun bruker. Bruk grafen når du svarer på spørsmålene. Omtrent hva har farten vært hvis hun bruker 1 time og 30 minutter? I km/h, oppgi bare tallet.",
    answer: "26.7",
    hint: "DECIMAL",
    points: 50,
    category: { connect: { id: "cler3o0ps000208kxhg7u2v0n" } },
  ...
  },
  {
    ...
    image:
      "https://tliacbojiuhirqtqavdn.supabase.co/storage/v1/object/public/task-images/day-one-tasks/task-2.33.png",
    description:
      "Mona skal kjøre en strekning på 40 km. Grafen viser sammenhengen mellom farten og tiden hun bruker. Bruk grafen når du svarer på spørsmålene. Hvor lang tid bruker hun hvis farten er 20 km/h? I timer, oppgi bare tallet.",
    answer: "2",
    points: 50,
    category: { connect: { id: "cler3o0ps000208kxhg7u2v0n" } },
  ...
  },
  {
    ...
    image:
      "https://tliacbojiuhirqtqavdn.supabase.co/storage/v1/object/public/task-images/day-one-tasks/task-2.33.png",
    description:
      "Mona skal kjøre en strekning på 40 km. Grafen viser sammenhengen mellom farten og tiden hun bruker. Bruk grafen når du svarer på spørsmålene. Omtrent hvor mange minutter bruker hun hvis farten er 50 km/h? I minutter, oppgi bare tallet.",
    answer: "48",
    points: 50,
    category: { connect: { id: "cler3o0ps000208kxhg7u2v0n" } },
  ...
  },
  {
    ...
    title: "Oppgave 2.34b",
    description:
      "Funksjonsuttrykket math$U(x)=\\frac{9000}{x}& viser utgiftene U som hver elev har når det reiser x antall elever på klassetur til Trondheim. Bestem grafisk hva prisen per elev blir når det er 75 elever som drar.",
    answer: "120kr",
    placeholder: "\\placeholder[blank1]{}kr",
    points: 75,
    category: { connect: { id: "cler3o0ps000208kxhg7u2v0n" } },
  ...
  // Oppgave 2.35.1
  {
    ...
    description:
      "En syklist skal sykle en strekning på 36 km. Farten er F km/h, og tiden hun bruker, er x timer. Vi får dette funksjonsuttrykket for farten: math$F(x)=\\frac{36}{x}&. Tegn grafen til funksjonen math$F(x)& med en graftegner. Hvor stor er farten hvis syklisten bruker 3 timer? I km/h, oppgi bare tallet.",
    answer: "12",
    points: 100,
    category: { connect: { id: "cler3o0ps000208kxhg7u2v0n" } },
  },
  ...
  },
  {
    ...
    description:
      "Marita leier en sykkel. Hun avtaler en leiepris på 2800 kr og kan da leie den i inntil 10 døgn. Bestem grafisk hvor mange døgn sykkelen er leid når prisen per dgn blir 560 kr. I døgn, oppgi bare tallet.",
    answer: "5",
    points: 75,
    category: { connect: { id: "cler3o0ps000208kxhg7u2v0n" } },
  ...
  },
  {
    ...
    description:
      "En elektrisk sparkesykkel koster 15kr i startpris og 2kr per minutt. Bestem grafisk hva prisen per minutt blir hvis sykkelen leies i 2 minutter.",
    answer: "9.5kr",
    hint: "DECIMAL",
    placeholder: "\\placeholder[blank1]{}kr",
    points: 75,
  ...
  // Oppgave 2.36.1
  {
    ...
    description:
      "Et rektangel har arealet math$24 cm^2&. Bredden er x cm, og lengden er l cm. Sammenhengen mellom lengden og bredden kan uttrykkes slik math$l(x)=\\frac{24}{x}&. Tegn grafen. Les av på grafen hvor stor bredden er når lengden er 6cm.",
    answer: "4cm",
    placeholder: "\\placeholder[blank1]{}cm",
    points: 50,
    category: { connect: { id: "cler3o0ps000208kxhg7u2v0n" } },
  },
  {
    ...
    image:
      "https://tliacbojiuhirqtqavdn.supabase.co/storage/v1/object/public/task-images/day-one-tasks/task-2.36.1.png",
    description:
      "Et rektangel har arealet math$24 cm^2&. Bredden er x cm, og lengden er l cm. Sammenhengen mellom lengden og bredden kan uttrykkes slik math$l(x)=\\frac{24}{x}&. Les av på grafen hvor stor lengden er når bredden er 10cm.",
    answer: "2.4cm",
    placeholder: "\\placeholder[blank1]{}cm",
    hint: "DECIMAL",
    points: 50,
  ...
  },
  {
    ...
    image:
      "https://tliacbojiuhirqtqavdn.supabase.co/storage/v1/object/public/task-images/day-one-tasks/task-2.36.2.png",
    description:
      "Et rektangel har et areal på math$100 cm^2&. Sidene er b og x + 5 lange. Funksjonsuttrykket math$b(x)=\\frac{100}{x+5}& beskriver sammenhengen mellom de to sidene når arealet er math$100 cm^2&. Bruk grafen til å finne bredden av b når x = 5.",
    answer: "10cm",
    placeholder: "\\placeholder[blank1]{}cm",
    points: 75,
    category: { connect: { id: "cler3o0ps000208kxhg7u2v0n" } },
  ...
  },
  {
    ...
    image:
      "https://tliacbojiuhirqtqavdn.supabase.co/storage/v1/object/public/task-images/day-one-tasks/task-2.36.2.png",
    description:
      "Et rektangel har et areal på math$100 cm^2&. Sidene er b og x + 5 lange. Funksjonsuttrykket math$b(x)=\\frac{100}{x+5}& beskriver sammenhengen mellom de to sidene når arealet er math$100 cm^2&. Bruk grafen til å finne lengden av x når b = 4.",
    answer: "20cm",
    placeholder: "\\placeholder[blank1]{}cm",
    points: 75,
    category: { connect: { id: "cler3o0ps000208kxhg7u2v0n" } },
  ...
  },
  {
    ...
    image:
      "https://tliacbojiuhirqtqavdn.supabase.co/storage/v1/object/public/task-images/day-one-tasks/task-2.36.3.png",
    description:
      "Et rektangel har et areal på math$60 cm^2&. Sidene er b og x - 1 lange. Bruk grafen til å finne lengden av bredden b når x = 10.",
    answer: "6.67cm",
    placeholder: "\\placeholder[blank1]{}cm",
    hint: "DECIMAL",
    points: 100,
  ...
  },
  {
    ...
    image:
      "https://tliacbojiuhirqtqavdn.supabase.co/storage/v1/object/public/task-images/day-one-tasks/task-2.36.3.png",
    description:
      "Et rektangel har et areal på math$60 cm^2&. Sidene er b og x - 1 lange. Bruk grafen til å finne lengden av x når b = 20.",
    answer: "4cm",
    placeholder: "\\placeholder[blank1]{}cm",
    points: 100,
    category: { connect: { id: "cler3o0ps000208kxhg7u2v0n" } },
  ...
  },
  {
    ...
    description:
      "I en bakteriekoloni er det flere tusen bakterier. Etter at kolonien har vokst i x minutter, er antallet bakterier B målt i tusen, B(x) er gitt ved funksjonsuttrykket math$B(x)=6x^2&. Hvor mange minutter har det gått når det er 3 750 000 bakterier i kolonien? I minutter, oppgi bare tallet.",
    answer: "25",
    points: 100,
    category: { connect: { id: "cler3oqyo000308kxe2au80ds" } },
  ...
  },
  {
    ...
    description:
      "Funksjonsuttrykket math$K(x)=-0.3x^2+6x& beskriver banen til en kule som skytes med stor fart opp i lufta. K er høyde over bakken i kilometer, og x er antall sekunder etter oppskytingen. Bruk grafen og finn ut hvor høyt over bakken kula var etter 10 sekunder.",
    answer: "30km",
    placeholder: "\\placeholder[blank1]{}km",
    points: 50,
    category: { connect: { id: "cler3oqyo000308kxe2au80ds" } },
  ...
  },
  {
    ...
    description:
      "Funksjonsuttrykket math$K(x)=-0.3x^2+6x& beskriver banen til en kule som skytes med stor fart opp i lufta. K er høyde over bakken i kilometer, og x er antall sekunder etter oppskytingen. Bruk grafen og finn ut hvor høyt over bakken kula var etter 5 sekunder.",
    answer: "22.5km",
    placeholder: "\\placeholder[blank1]{}km",
    hint: "DECIMAL",
    points: 75,
  ...
  },
  {
    ...
    description:
      "Funksjonsuttrykket math$K(x)=-0.3x^2+6x& beskriver banen til en kule som skytes med stor fart opp i lufta. K er høyde over bakken i kilometer, og x er antall sekunder etter oppskytingen. Etter hvilke to tider var kula 15 km over bakken? I sekunder, oppgi bare tallet.",
  ...
  // Oppgave 2.52.3
  {
    ...
    description:
      "Gitt funksjonen math$F(x)=10000 \\cdot 1.02^x&, hva blir gjennomsnittlig veksthastighet for den lineære funksjonen som går gjennom punktene math$(0,10000)& og math$(10,12190)&? For innbyggere/år, oppgi bare tallet.",
    answer: "219",
    points: 150,
    category: { connect: { id: "cleebx9wi000508jt5ik9fgpx" } },
  ...
  // Oppgave 2.53.1
  {
    ...
    description:
      "Et spillselskap selger 8 millioner dataspill et år. Selskapet tror omsetningen i årene fremover vil øke med 4% per år. Hvor mange dataspill selger selskapet etter 2 år? I millioner, oppgi bare tallet.",
    answer: "8.6528",
    hint: "DECIMAL",
    points: 50,
    category: { connect: { id: "cleebx9wi000508jt5ik9fgpx" } },
  ...
  // Oppgave 2.53.3
  {
    ...
    description:
      "Gitt funksjonen math$S(x)=8 \\cdot 1.04^x&, hvor mange spill selges etter 8 år? I millioner, opggi bare tallet.",
    answer: "10.95",
    hint: "DECIMAL",
    points: 75,
    category: { connect: { id: "cleebx9wi000508jt5ik9fgpx" } },
  ...
  // Oppgave 2.54.2
  {
    ...
    description:
      "Espen kjøper en brukt elbil til 450 000 kr. Han regner med at bilen taper seg i verdi med 12 % hvert år siden han kjøpte den. Verdien V av bilen etter x år blir da math$V(x)=450000 \\cdot 0.88^x&. Etter hvor mange år blir verdien av bilen under 200 000 kr? I år, oppgi bare tallet.",
    answer: "6.34",
    hint: "DECIMAL",
    points: 75,
    category: { connect: { id: "cleebx9wi000508jt5ik9fgpx" } },
  ...
  // Oppgave 2.54.3
  {
    ...
    description:
      "Espen kjøper en brukt elbil til 450 000 kr. Han regner med at bilen taper seg i verdi med 12 % hvert år siden han kjøpte den. Verdien V av bilen etter x år blir da math$V(x)=450000 \\cdot 0.88^x&. Hvor mange år går det før bilen er verdt mindre enn 200 000 kr? I år, oppgi bare tallet.",
    answer: "6.34",
    hint: "DECIMAL",
    points: 75,
    category: { connect: { id: "cleebx9wi000508jt5ik9fgpx" } },
  ...
  },
  {
    ...
    description:
      "Espen kjøper en brukt elbil til 450 000 kr. Han regner med at bilen taper seg i verdi med 12 % hvert år siden han kjøpte den. Verdien V av bilen etter x år blir da math$V(x)=450000 \\cdot 0.88^x&. Hvor gammel var bilen da Espen kjøpte bilen hvis nypris på bilen var 660 000 kr? I år, oppgi bare tallet.",
    answer: "3",
    points: 125,
    category: { connect: { id: "cleebx9wi000508jt5ik9fgpx" } },
