...
export default function TaskPage() {
  ...
  return (
    <div className="mt-10 flex flex-col items-center justify-center gap-12 rounded-md border-2 border-brand-blue bg-brand-red py-10 shadow-4-right shadow-brand-blue">
